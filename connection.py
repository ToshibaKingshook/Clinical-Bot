...
def getvalue():    
    ...
    try:
        op = RandomForest.RandomForest_pred(age, sex, cp, trestbps, chol, fbs, restecg, thalach, exang, oldpeak, slope, ca, thal)
    except Exception as e:
        print(type(e).__name__)
    global speech
    if op == 0: 
        opstr = "No Heart Disease"
        speech = "There is no problem in your report. Your Report Looks Fine."
    if op == 1: 
        opstr = "Heart Disease Present"
        speech = "There is some abnormalities in your report. But don't worry, we are here to help!"
    # print(op, opstr)
